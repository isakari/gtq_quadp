...
!!$               +sin(x)*gt(3)%s(4)%we(3,ig)&
!!$               +cos(x)*gt(3)%s(4)%we(4,ig)&
...
!!$               +sin(x)*gt(3)%s(5)%we(3,ig)&
!!$               +cos(x)*gt(3)%s(5)%we(4,ig)&
!!$               -sin(x)*gt(3)%s(5)%we(5,ig)&
!!$               -cos(x)*gt(3)%s(5)%we(6,ig)&
...
!!$               +sin(x)*gt(3)%s(6)%we(3,ig)&
!!$               +cos(x)*gt(3)%s(6)%we(4,ig)&
!!$               -sin(x)*gt(3)%s(6)%we(5,ig)&
!!$               -cos(x)*gt(3)%s(6)%we(6,ig)&
!!$               +sin(x)*gt(3)%s(6)%we(7,ig)&
!!$               +cos(x)*gt(3)%s(6)%we(8,ig)&
...
!!$               +sin(x)*gt(3)%s(7)%we(3,ig)&
!!$               +cos(x)*gt(3)%s(7)%we(4,ig)&
!!$               -sin(x)*gt(3)%s(7)%we(5,ig)&
!!$               -cos(x)*gt(3)%s(7)%we(6,ig)&
!!$               +sin(x)*gt(3)%s(7)%we(7,ig)&
!!$               +cos(x)*gt(3)%s(7)%we(8,ig)&
